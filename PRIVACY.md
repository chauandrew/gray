...
- image and video elements on the page, to hide, mute, or reveal them
...
| Content script on all sites | Paint blocked-image placeholders, mute video, and handle click-to-reveal. |
